...
class pa_three_anten(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "pa_three_anten")
        ...
        self.freq_wave_0 = freq_wave_0 = 2.4e9

        ##################################################
        # Blocks
        ##################################################

        self._t_gain_range = qtgui.Range(0, 50, 1, 30, 200)
    ...
    def set_freq_wave(self, freq_wave):
        ...
        self.qtgui_freq_sink_x_0_0.set_frequency_range(self.freq_wave, self.samp_rate)
    ...
    def get_freq_wave_0(self):
        return self.freq_wave_0

    def set_freq_wave_0(self, freq_wave_0):
        self.freq_wave_0 = freq_wave_0




def main(top_block_cls=pa_three_anten, options=None):
