...
class first_try_pa(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.band_pass_filter_0_0, 0), (self.qtgui_freq_sink_x_0, 1))
    ...
    def set_freq_wave(self, freq_wave):
        ...
        self.band_pass_filter_0.set_taps(firdes.complex_band_pass(1, self.samp_rate, (0.9 * self.freq_wave), (1.1 * self.freq_wave), (0.01 * self.freq_wave), window.WIN_HAMMING, 6.76))
        self.band_pass_filter_0_0.set_taps(firdes.complex_band_pass(1, self.samp_rate, (0.9 * self.freq_wave), (1.1 * self.freq_wave), (0.01 * self.freq_wave), window.WIN_HAMMING, 6.76))
