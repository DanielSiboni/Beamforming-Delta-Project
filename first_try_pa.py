...
class first_try_pa(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.jammer_angle_deg = jammer_angle_deg = 0
        self.freq_wave = freq_wave = 2.49e9
        self.wavelength = wavelength = 299792458.0 / freq_wave
        ...
        self.freq_wave_2 = freq_wave_2 = 100e3
        self.d_x_2 = d_x_2 = 0.03
        self.c_light_speed = c_light_speed = 299792458.0
        self.T_gain = T_gain = 30
        self.R_gain = R_gain = 30

        ##################################################
        # Blocks
        ##################################################

        self._T_gain_range = qtgui.Range(0, 30, 1, 30, 200)
        self._T_gain_win = qtgui.RangeWidget(self._T_gain_range, self.set_T_gain, "'T_gain'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._T_gain_win)
        self._R_gain_range = qtgui.Range(0, 50, 1, 30, 200)
        self._R_gain_win = qtgui.RangeWidget(self._R_gain_range, self.set_R_gain, "'R_gain'", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.uhd_usrp_source_0.set_center_freq(freq_wave, 0)
        self.uhd_usrp_source_0.set_antenna("RX2", 0)
        self.uhd_usrp_source_0.set_gain(R_gain, 0)

        self.uhd_usrp_source_0.set_center_freq(freq_wave, 1)
        self.uhd_usrp_source_0.set_antenna("RX2", 1)
        self.uhd_usrp_source_0.set_gain(R_gain, 1)
        ...
        self.uhd_usrp_sink_0_0.set_subdev_spec("A:A A:B", 0)
        self.uhd_usrp_sink_0_0.set_samp_rate(samp_rate)
        self.uhd_usrp_sink_0_0.set_time_unknown_pps(uhd.time_spec(0))

        self.uhd_usrp_sink_0_0.set_center_freq(freq_wave, 0)
        self.uhd_usrp_sink_0_0.set_antenna("TX/RX", 0)
        self.uhd_usrp_sink_0_0.set_gain(T_gain, 0)
        ...
        self._jammer_angle_deg_range = qtgui.Range(-90, 90, 1, 0, 200)
        ...
        self.beamod_two_channel_aligner_0_0 = beamod.two_channel_aligner(samp_rate, 3.0)
        self.beamod_two_channel_aligner_0 = beamod.two_channel_aligner(samp_rate, 3.0)
        self.beamod_pilot_sync_0 = beamod.pilot_sync()
        self.beamod_mvdr_beamformer_0 = beamod.mvdr_beamformer(0.0, [0, d_x, d_x+d_x_2], freq_wave, (512 * 10))
        self.band_pass_filter_0_0 = filter.fir_filter_ccf(
            ...
            firdes.band_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.analog_sig_source_x_1 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, pilot_offset, 1, 0, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_const_source_x_0, 0), (self.uhd_usrp_sink_0_0, 1))
        self.connect((self.analog_sig_source_x_1, 0), (self.freq_xlating_fir_filter_xxx_0, 0))
        self.connect((self.analog_sig_source_x_1, 0), (self.uhd_usrp_sink_0_0, 0))
        ...
        self.connect((self.beamod_pilot_sync_0, 1), (self.beamod_mvdr_beamformer_0, 2))
        self.connect((self.beamod_pilot_sync_0, 0), (self.blocks_null_sink_0, 0))
        ...
        self.connect((self.beamod_two_channel_aligner_0_0, 1), (self.beamod_pilot_sync_0, 1))
        self.connect((self.beamod_two_channel_aligner_0_0, 0), (self.beamod_pilot_sync_0, 0))
        ...
        self.connect((self.uhd_usrp_source_0, 0), (self.beamod_two_channel_aligner_0, 0))
        self.connect((self.uhd_usrp_source_0, 1), (self.beamod_two_channel_aligner_0, 1))
        self.connect((self.uhd_usrp_source_0_0, 1), (self.beamod_two_channel_aligner_0_0, 1))
        self.connect((self.uhd_usrp_source_0_0, 0), (self.beamod_two_channel_aligner_0_0, 0))
    ...
    def set_freq_wave(self, freq_wave):
        ...
        self.set_wavelength(299792458.0 / self.freq_wave)
        self.uhd_usrp_sink_0_0.set_center_freq(self.freq_wave, 0)
        self.uhd_usrp_source_0.set_center_freq(self.freq_wave, 0)
        self.uhd_usrp_source_0.set_center_freq(self.freq_wave, 1)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0_0.set_taps(firdes.band_pass(1, self.samp_rate, (0.9 * self.freq_wave_2), (1.1 * self.freq_wave_2), (0.01 * self.freq_wave_2), window.WIN_HAMMING, 6.76))
    ...
    def set_pilot_offset(self, pilot_offset):
        ...
        self.analog_sig_source_x_1.set_frequency(self.pilot_offset)
    ...
    def get_freq_wave_2(self):
        return self.freq_wave_2

    def set_freq_wave_2(self, freq_wave_2):
        self.freq_wave_2 = freq_wave_2
        self.band_pass_filter_0_0.set_taps(firdes.band_pass(1, self.samp_rate, (0.9 * self.freq_wave_2), (1.1 * self.freq_wave_2), (0.01 * self.freq_wave_2), window.WIN_HAMMING, 6.76))

    def get_d_x_2(self):
        return self.d_x_2

    def set_d_x_2(self, d_x_2):
        self.d_x_2 = d_x_2
    ...
    def set_T_gain(self, T_gain):
        self.T_gain = T_gain
        self.uhd_usrp_sink_0_0.set_gain(self.T_gain, 0)
    ...
    def set_R_gain(self, R_gain):
        self.R_gain = R_gain
        self.uhd_usrp_source_0.set_gain(self.R_gain, 0)
        self.uhd_usrp_source_0.set_gain(self.R_gain, 1)
