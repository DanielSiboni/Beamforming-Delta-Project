...
class lms_try(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lms_try")
        ...
        self.beamod_lms_beamformer_0 = beamod.lms_beamformer(2, 0.001)
...
def main(top_block_cls=lms_try, options=None):
